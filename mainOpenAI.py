...
OPENAI_API_KEY = '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'
...
image_prompts,image_urls,captions=generate_advertisement("You are advertising a new brand of shoes. The brand name is 'ShoeX'. The shoes are made of a new material that is both waterproof and breathable. The shoes are available in 5 different colors and are designed for students in Singapore.", number_of_images=2)
